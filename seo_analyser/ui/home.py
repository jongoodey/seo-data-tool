...
SHORTCUTS = [
    ...
    ("Backlink summary", "Backlink profile metrics for any domain",
     "backlinks", "summary_live"),
    ("Explore backlinks", "Individual backlinks with anchors and sources",
     "backlinks", "backlinks_live"),
    ("Find link gaps", "Domains linking to competitors but not you",
     "backlinks", "domain_intersection_live"),
    ("New & lost links", "Backlink gains and losses over time",
     "backlinks", "timeseries_new_lost_summary_live"),
    ("Bulk backlink checks", "Backlink counts for many domains at once",
     "backlinks", "bulk_backlinks_live"),
